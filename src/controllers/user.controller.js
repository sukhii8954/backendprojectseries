...
const registerUser = asyncHandler(async (req, res) => {
   ...
   const exisitedUser = User.findOne({ // if get any existed email or username and check if either of it already exists of not
        $or: [{ email }, { username }]  // usin or operator to check either of its already exist or not in Db
    })
